...
const profileSwaggerDocument: OpenApiSpec = {
  ...
  info: {
    ...
    version: "1.0.0",
    description:
      "API for managing user profile details, including updating username, date of birth, email, and password.",
  },
  servers: [
    {
  ...
  paths: {
    "/api/v1/auth/update-details/{id}": {
      put: {
        summary: "Update user details",
        description:
          "Updates the authenticated user’s username and/or date of birth.",
        tags: ["Profile"],
        security: [
          {
            bearerAuth: [],
                ...
                schema: {
                  ...
                  properties: {
                    ...
                    message: {
                      type: "string",
                      example:
                        "Forbidden: Cannot update another user’s details",
                    },
                  },
                },
              },
    ...
    "/api/v1/auth/update-email/{id}": {
      put: {
        summary: "Initiate email update",
        description:
          "Initiates an email update for the authenticated user by sending an OTP to the new email.",
        tags: ["Profile"],
        security: [
          {
            bearerAuth: [],
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    message: {
                      type: "string",
                      example: "Forbidden: Cannot update another user’s email",
                    },
                  },
                },
              },
                ...
                schema: {
                  ...
                  properties: {
                    ...
                    message: {
                      type: "string",
                      example:
                        "Too many email update attempts. Try again later.",
                    },
                  },
                },
              },
    ...
    "/api/v1/auth/update-password/{id}": {
      post: {
                ...
                schema: {
                  ...
                  properties: {
                    ...
                    message: {
                      type: "string",
                      example:
                        "Forbidden: Cannot update another user’s password",
                    },
                  },
                },
              },
