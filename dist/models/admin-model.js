...
adminSchema.methods.logLoginAttempt = function (ip, success) {
    return __awaiter(this, void 0, void 0, function* () {
...
adminSchema.methods.invalidateOtherSessions = function () {
    return __awaiter(this, void 0, void 0, function* () {
        this.sessionVersion = (this.sessionVersion || 0) + 1;
        yield this.save();
    });
};
const Admin = mongoose_1.default.model("MarketPlaceAdmins", adminSchema);
