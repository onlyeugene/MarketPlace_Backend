    ...
    paths: {
                            ...
                            "application/json": {
                                schema: {
                                    ...
                                    properties: {
                                        ...
                                        message: {
                                            type: "string",
                                            example: "Registration successful, please verify OTP sent to your email",
                                        },
                                        data: {
                                            type: "object",
                                            properties: {
                            ...
                            "application/json": {
                                schema: {
                                    ...
                                    properties: {
                                        ...
                                        message: {
                                            type: "string",
                                            example: "Too many registration attempts. Try again later.",
                                        },
                                    },
                                },
                            },
        ...
        "/api/v1/auth/deactivate": {
            post: {
                ...
                description: "Deactivates the authenticated user account with an optional reason.",
                tags: ["Authentication"],
                security: [{ bearerAuth: [] }],
                requestBody: {
                    required: false,
